...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.3.268.0/windows/VulkanSDK-1.3.268.0-Installer.exe'
ASTAN_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'Astan/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (ASTAN_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Astan requires {ASTAN_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "Astan/vendor/VulkanSDK"
