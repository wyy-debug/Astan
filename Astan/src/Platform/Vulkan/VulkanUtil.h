...
namespace Astan
{
    ...
    public:
        ...
        static void           createBufferAndInitialize(VkDevice              device,
            ...
            void* data = nullptr,
            int                   datasize = 0);
        static void           copyBuffer(RendererAPI* rhi,
            VkBuffer     srcBuffer,
            VkBuffer     dstBuffer,
        ...
        static VkImageView    createImageView(VkDevice           device,
            ...
            uint32_t           miplevels);
        static void           createGlobalImage(RendererAPI* rhi,
            VkImage& image,
        ...
        static void           createCubeMap(RendererAPI* rhi,
            VkImage& image,
            VkImageView& image_view,
            VmaAllocation& image_allocation,
            uint32_t             texture_image_width,
            ...
            RHIFormat   texture_image_format,
            uint32_t             miplevels);
        static void           generateTextureMipMaps(RendererAPI* rhi,
            VkImage  image,
            ...
            uint32_t layers,
            uint32_t miplevels);
        static void           transitionImageLayout(RendererAPI* rhi,
            VkImage            image,
        ...
        static void           copyBufferToImage(RendererAPI* rhi,
            VkBuffer buffer,
            VkImage  image,
            uint32_t width,
            uint32_t height,
            uint32_t layer_count);
        static void genMipmappedImage(RendererAPI* rhi, VkImage image, uint32_t width, uint32_t height, uint32_t mip_levels);
