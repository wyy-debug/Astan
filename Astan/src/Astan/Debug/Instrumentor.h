...
#define AS_PROFILE 1
#if AS_PROFILE
#define AS_PROFILE_BEGIN_SESSION(name,filepath) ::Astan::Instrumentor::Get().BeginSession(name,filepath)
#define AS_PROFILE_END_SESSION() ::Astan::Instrumentor::Get().EndSession()
#define AS_PROFILE_SCOPE(name) ::Astan::InstrumentationTimer time##__LINE__(name);
