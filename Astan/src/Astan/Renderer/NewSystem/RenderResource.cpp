...
namespace Astan
{
    ...
    void RenderResource::UploadGlobalRenderResource(Ref<RendererAPI> rhi, LevelResourceDesc level_resource_desc)
    {
    ...
    void RenderResource::UploadGameObjectRenderResource(Ref<RendererAPI> rhi,
    ...
    void RenderResource::UpdatePerFrameBuffer(Ref<Scene>  render_scene,
        Ref<EditorCamera> camera)
    {
        ...
        m_particle_collision_perframe_storage_buffer_object.proj_inv_matrix = glm::inverse(proj_matrix);
    ...
    void RenderResource::CreateIBLSamplers(Ref<RendererAPI> rhi)
    {
    ...
    void RenderResource::CreateIBLTextures(Ref<RendererAPI>                        rhi,
    ...
    VulkanMesh&
        RenderResource::GetOrCreateVulkanMesh(Ref<RendererAPI> rhi, RenderEntity entity, RenderMeshData mesh_data)
    {
    ...
    VulkanPBRMaterial& RenderResource::GetOrCreateVulkanMaterial(Ref<RendererAPI> rhi,
        RenderEntity         entity,
        RenderMaterialData   material_data)
    {
    ...
    void RenderResource::UpdateMeshData(Ref<RendererAPI>                   rhi,
    ...
    void RenderResource::UpdateVertexBuffer(Ref<RendererAPI>                   rhi,
        bool                                   enable_vertex_blending,
        uint32_t                               vertex_buffer_size,
        MeshVertexDataDefinition const* vertex_buffer_data,
        uint32_t                               joint_binding_buffer_size,
    ...
    void RenderResource::UpdateIndexBuffer(Ref<RendererAPI> rhi,
        uint32_t             index_buffer_size,
        void* index_buffer_data,
        VulkanMesh& now_mesh)
    {
    ...
    void RenderResource::UpdateTextureImageData(Ref<RendererAPI> rhi, const TextureDataToUpdate& texture_data)
    {
        rhi->CreateGlobalImage(
    ...
    void RenderResource::CreateAndMapStorageBuffer(Ref<RendererAPI> rhi)
    {
        VulkanRendererAPI* raw_rhi = static_cast<VulkanRendererAPI*>(rhi.get());
