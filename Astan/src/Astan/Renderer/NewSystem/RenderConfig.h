...
namespace Astan
{
    ...
    {
        glm::mat4 joint_matrices[s_mesh_vertex_blending_max_joint_count * s_mesh_per_drawcall_max_instance_count];
    };
    ...
    struct MeshPointLightShadowPerframeStorageBufferObject
    {
        ...
        uint32_t _padding_point_light_num_2;
        uint32_t _padding_point_light_num_3;
        glm::vec4  point_lights_position_and_radius[s_max_point_light_count];
    };
    ...
    {
        glm::vec4 positions[s_particle_billboard_buffer_size];
        glm::vec4 sizes[s_particle_billboard_buffer_size];
        glm::vec4 colors[s_particle_billboard_buffer_size];
    };
    ...
    {
        glm::mat4 model_matrices[s_mesh_per_drawcall_max_instance_count];
