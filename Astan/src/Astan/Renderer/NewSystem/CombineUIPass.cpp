...
namespace Astan
{
    ...
    void CombineUIPass::SetupPipelines()
    {
        ...
        RHIShader* frag_shader_module = m_RenderCommand->CreateShaderModule(COMBINE_UI_FRAG);
        ...
        RHIImageView* ui_input_attachment)
    {
        ...
        per_frame_scene_input_attachment_info.sampler = m_RenderCommand->GetOrCreateDefaultSampler(Default_Sampler_Nearest);
        ...
        per_frame_ui_input_attachment_info.sampler = m_RenderCommand->GetOrCreateDefaultSampler(Default_Sampler_Nearest);
    ...
    void CombineUIPass::Draw()
    {
        ...
        m_RenderCommand->PushEvent(m_RenderCommand->GetCurrentCommandBuffer(), "Combine UI", color);
        ...
        RHIViewport viewport = { 0.0,
                               ...
                               0.0,
                               1.0 };
        RHIRect2D   scissor = { 0, 0, m_RenderCommand->GetSwapchainInfo().extent.width, m_RenderCommand->GetSwapchainInfo().extent.height };
