...
namespace Astan
{
    enum class ASTAN_PIXEL_FORMAT : uint8_t
    {
        ASTAN_PIXEL_FORMAT_UNKNOWN = 0,
        ASTAN_PIXEL_FORMAT_R8G8B8_UNORM,
        ASTAN_PIXEL_FORMAT_R8G8B8_SRGB,
        ASTAN_PIXEL_FORMAT_R8G8B8A8_UNORM,
        ASTAN_PIXEL_FORMAT_R8G8B8A8_SRGB,
        ASTAN_PIXEL_FORMAT_R32G32_FLOAT,
        ASTAN_PIXEL_FORMAT_R32G32B32_FLOAT,
        ASTAN_PIXEL_FORMAT_R32G32B32A32_FLOAT
    };
    enum class ASTAN_IMAGE_TYPE : uint8_t
    {
        ASTAN_IMAGE_TYPE_UNKNOWM = 0,
        ASTAN_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        ASTAN_IMAGE_TYPE   m_type{ ASTAN_IMAGE_TYPE::ASTAN_IMAGE_TYPE_UNKNOWM };
